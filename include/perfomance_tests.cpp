...
#include "collections/max_priority_queue_doubly_linked_list.h"
#include "collections/max_priority_queue_heap.h"
...
int runStructureMenu() {
    ...
    while (true) {
        ...
        if (topicChoice==1) {
            ...
            std::cout<<"Choose the structure:\n1-Max priority queue doubly linked list\n2-Max priority queue heap\n3-All tests at once\n";
            std::cin >> structureChoice;
